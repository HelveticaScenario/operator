...
**YOU ARE IN: `operator/polecats/capable/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/operator/` (rig root) or other directories

```bash
pwd  # Should show .../polecats/capable
```
...
**Your mail address:** `operator/polecats/capable`
**Your rig:** operator
**Your Witness:** `operator/witness`
...
1. Announce: "Polecat capable, checking in."
...
| Ask Witness for help | `gt mail send operator/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`operator/witness`) when:
...
```bash
gt mail send operator/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
