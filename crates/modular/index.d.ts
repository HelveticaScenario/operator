...
export declare class Synthesizer {
     ...
     */
    getScopeXy(): Array<
        [ScopeXyBufferKey, Float32Array, Float32Array, ScopeXyRanges]
    >;
    updatePatch(
        patch: PatchGraph,
        trigger?: QueuedTrigger | undefined | null,
        resetClock?: boolean | undefined | null,
    ): PatchUpdateResult;
 ...
 */
export declare function deriveChannelCount(
    moduleType: string,
    params: any,
 ...
 */
export declare function validatePatchGraph(
    patch: PatchGraph,
