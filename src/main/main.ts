...
// frame). Disabling this keeps the renderer painting while obscured. Must be set
// before app `ready`.
...
const createWindow = (): void => {
    ...
    mainWindow = new BrowserWindow({
        ...
        webPreferences: {
            // Keep timers/rAF (scope animations) running at full rate when the
            // window is backgrounded, so Syphon capture of a covered window keeps
            // updating. See also the CalculateNativeWinOcclusion switch below.
